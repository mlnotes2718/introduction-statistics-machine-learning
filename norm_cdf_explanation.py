...
def demonstrate_cdf_calculation():
    ...
    print("CDF(z) = P(Z <= z) = integral from -infinity to z of f(x) dx")
    print("This is the area under the curve from -infinity to z")
    print()
...
def manual_cdf_approximation(z, n_intervals=1000):
    ...
    # (we use -10 instead of -infinity because the probability beyond -10 is negligible)
    lower_bound = -10
...
def step_by_step_example():
    ...
    print(f"   integral from -infinity to {z} of (1/sqrt(2*pi)) * e^(-x^2/2) dx")
    print()
